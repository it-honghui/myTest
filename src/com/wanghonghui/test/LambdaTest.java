...
import com.wanghonghui.model.Employee;
...
//        };
        ...
        demo.printSomething(something, printer -> System.out.println(printer));
    }
...
//                }).collect(Collectors.toList());
    ...
    /**
     * distinct 去重
     * sorted 排序，是按照字母的自然顺序进行排序，第一位无法区分顺序，就比较第二位字母。
     */
    @Test
    public void test10() {
...
//        List<String> alphabeticOrder = Stream.of("Monkey", "Lion", "Giraffe", "Lemur")
     ...
     * 通常情况下，parallel()能够很好的利用CPU的多核处理器，达到更好的执行效率和性能，建议使用。
...
//        employees.sort(Comparator.comparing(Employee::getAge));
     ...
     * parallel 利用系统多核CPU多线程执行，不能保证顺序
     * ForEachOrdered 加上了排序，可以保证顺序
     */
    @Test
    public void test16() {
        Stream.of("Monkey", "Lion", "Giraffe", "Lemur", "Lion")
